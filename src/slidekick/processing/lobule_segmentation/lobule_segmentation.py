...
class LobuleSegmentor(BaseOperator):
    ...
    def __init__(self,
                 ...
                 pp_gamma: float = 0.25,
                 pv_gamma: float = 0.3,
                 nl_low_pct: float = 27.0,
                 nl_high_pct: float = 85.5,
                 ...
                 vessel_zone_ratio_thr_pp: float = 0.9,
                 vessel_zone_ratio_thr_pv: float = 0.35,
                 vessel_circularity_min: float = 0.26,
                 vessel_circ_check_area_pp: int = 2000,
                 vessel_circ_check_area_pv: int = 2000,
                 vessel_pct_low: float = 6.5,
                 vessel_pct_superpixel_frac: float = 0.75,
